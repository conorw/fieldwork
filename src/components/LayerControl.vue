          ...
          <div class="layer-item">
            <label class="layer-checkbox">
              ...
              <div
                ...
                :class="{ checked: baseLayerVisible }"
              >
                <svg
                  v-if="baseLayerVisible"
...
const availableLayers = computed(() => [
  {
    ...
    name: "Buildings",
    color: "#8B4513",
    visible: layerVisibility.value.buildings,
  },
  {
    id: "earth",
    name: "Earth",
    color: "#8B7355",
    visible: layerVisibility.value.earth,
  },
  {
    id: "landuse",
    name: "Land Use",
    color: "#90EE90",
    visible: layerVisibility.value.landuse,
  },
  {
    id: "pois",
    name: "Points of Interest",
    color: "#FF6B6B",
    visible: layerVisibility.value.pois,
  },
  {
    id: "roads",
    name: "Roads",
  ...
  },
  {
    ...
    name: "Water",
    color: "#4A90E2",
    visible: layerVisibility.value.water,
  },
]);
...
const toggleLayer = (layerId) => {
  ...
  console.log(
    `🔍 LayerControl: Layer ${layerId} is now:`,
  ...
  try {
    ...
    layers.forEach((layer, index) => {
      ...
      if (layer.getSource && layer.getSource().getUrl) {
        console.log(
          `🔍 LayerControl: Setting base layer visibility to:`,
          baseLayerVisible.value,
        );
    ...
    console.log(
      "🔍 LayerControl: Updating global layer visibility:",
