<template>
  <div v-if="images && images.length > 0" class="mb-3">
    <div class="flex space-x-2 overflow-x-auto">
      <div
        v-for="image in images.slice(0, maxThumbnails)"
        :key="image.id"
      ...
      >
        ...
        <div
          v-if="showHoverActions || showDeleteButton"
